...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{url('welcome')}}/assets/img/favicon.ico" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">portfolio.com</a>
        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary js-scroll-trigger" href="#about">See Demo Portfolio</a>
                </div>
            </div>
        </header>
        <!-- About-->
        ...
        <!-- Core theme JS-->
        <script src="{{url('welcome')}}/js/scripts.js"></script>
    </body>
</html>
